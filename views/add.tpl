...
<!-- 
    ...
    {{if gt (.list|len) 1}}
      <label>选项：</label>
        <th>
          <div class="form-group">
            <input id="myCar"  class="form-control" placeholder="请选择" list="cars" name="choose"/>  
          </div>
          <div id='datalistDiv'>
  ...
  <table class="table table-striped">
    ...
    <tbody>
      <tr>
        ...
        <th>
          <div class="form-group">
            <input id="name" class="form-control"  placeholder="填写名称" name="name"></div>
        </th>
        {{if gt (.list|len) 1}}
        <th>
          <div class="form-group">
            <input id="myCar"  class="form-control" placeholder="请选择" list="cars" />  
          </div>
          <div id='datalistDiv'>
            <datalist id="cars" name="cars"></datalist>
          </div>
